    ...
    <header class="nlpi-header">
        <div class="nlpi-header-main">
            ...
            <div class="nlpi-header-right">
                ...
                <transition name="sidebar-slide">
                    <aside v-if="isMobileMenuOpen" class="sidebar-nav" @click.stop>
                        ...
                        <nav class="nlpi-nav-mobile">
                            <div class="nlpi-nav-link nav-dropdown" @click="toggleSubMenu('info')">
                                <span class="nav-label">最新資訊</span>
                                <div v-if="submenuStates.info" class="dropdown-menu">
                            ...
                            <div class="nlpi-nav-link nav-dropdown" @click="toggleSubMenu('reader')">
                                <span class="nav-label">讀者服務</span>
                                <div v-if="submenuStates.reader" class="dropdown-menu">
                                    <div @click="toggleSubMenu('apply')">
                                    ...
                                    <div @click="toggleSubMenu('catalogue')">
                                    ...
                                    <div @click="toggleSubMenu('reserve')">
                                    ...
                                    <div @click="toggleSubMenu('borrow')">
                                    ...
                                    <div @click="toggleSubMenu('ranking')">
                            ...
                            <div class="nlpi-nav-link nav-dropdown" @click="toggleSubMenu('location')">
                                <span class="nav-label">地點 & 時間</span>
                                <div v-if="submenuStates.location" class="dropdown-menu">
                            ...
                            <div class="nlpi-nav-link nav-dropdown" @click="toggleSubMenu('about')">
                                <span class="nav-label">關於我們</span>
                                <div v-if="submenuStates.about" class="dropdown-menu">
                ...
                <!-- 桌面版導航 -->
                <nav class="nlpi-nav" :class="{ 'open': isMobileMenuOpen }">
                    <div class="nlpi-nav-link nav-dropdown" @mouseenter="showInfoMenu = true"
                                                ...
                                                <div class="service-card-icon">
                                                    <template v-if="!isLoggedIn">
                                                        <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
                                                            ...
                                                            <rect x="14" y="20" width="8" height="8" rx="2"
                                                                stroke="#003366" stroke-width="2" />
                                                    ...
                                                    <template v-else>
                                                        <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
                                                            <circle cx="24" cy="18" r="10" stroke="#003366"
                                                ...
                                                <div class="service-card-icon">
                                                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
                                                        <rect x="12" y="10" width="24" height="28" rx="2"
                                                            stroke="#003366" stroke-width="2" />
                                                        <rect x="16" y="16" width="16" height="2" rx="1"
                                                            fill="#003366" />
                                                        <rect x="16" y="22" width="16" height="2" rx="1"
                                                            fill="#003366" />
                                                        <rect x="16" y="28" width="10" height="2" rx="1"
                                                            fill="#003366" />
                                                    </svg>
                                                </div>
                                                ...
                                                <div class="service-card-icon">
                                                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
                                                        <rect x="8" y="16" width="32" height="16" rx="3"
                                                            stroke="#003366" stroke-width="2" />
                                                        <rect x="16" y="24" width="16" height="6" rx="2"
                                                            fill="#003366" />
                                                    </svg>
                                                </div>
                                                ...
                                                <div class="service-card-icon">
                                                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
                                                        <rect x="10" y="14" width="28" height="20" rx="3"
                                                            stroke="#003366" stroke-width="2" />
                                                        <rect x="16" y="20" width="16" height="2" rx="1"
                                                            fill="#003366" />
                                                        <rect x="16" y="26" width="10" height="2" rx="1"
                                                            fill="#003366" />
                                                    </svg>
                                                </div>
