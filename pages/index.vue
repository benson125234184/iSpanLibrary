      ...
      <div class="news-list-bottom">
        <div class="news-card-small" v-for="news in newsList.slice(1, 4)" :key="news.id">
          ...
          <div class="news-info-small">
            ...
            <div class="news-desc-small">{{ news.desc }}</div>
          </div>
        </div>
      </div>
    </section>
...
// 書籍輪播資料
const bookList = [
  { title: '森林裡的圖書館', img: '/images/library-building.jpg' },
  { title: '閱讀新世界', img: '/images/羅布森圖書館室內模擬圖.jpg' },
  { title: '翻頁的奇蹟', img: '/images/book-flip.gif' },
  { title: '親子共讀時光', img: '/images/17698e741cbc833e9aa2e2004c84abb1.webp' },
  { title: '知識的寶庫', img: '/images/0d58b793-5651-4858-be9d-260a20b4f394.png' },
  { title: '書香滿室', img: '/images/03adb31f-0963-4f6a-a124-50ad861e053f.png' },
]
